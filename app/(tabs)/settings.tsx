...
import { User, ChevronRight, Shield, Bell, HelpCircle, LogOut, Mail, Phone, BadgeCheck } from 'lucide-react-native';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.header}>
                    ...
                    <ThemedText style={styles.username}>@{user?.name?.toLowerCase().replace(' ', '_') || 'user'} • Premium</ThemedText>
                </View>
